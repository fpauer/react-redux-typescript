...
class ProfileStartCertifications extends React.Component<any, any> {
	...
	onInfoGathered(data) {
		...
		if(!data.certifications.length) {
			this.props.dispatch(ProfileActionCreators.profileErrors(['Please enter certifications.']));
		} else {
	...
	render() {
		return (
			<div className="profile-start-certifications">
				<ProfileCertifications onInfoGathered={this.onInfoGathered}/>
			</div>
		);
	}
...
export default connect(ProfileStartCertifications.mapStateToProps)(ProfileStartCertifications);